...
type
  ...
  TChdDTimeItemList = TList<TChdDTimeItem>;

  TChdPeriod = class(TCustomMf6Persistent)
  private
    IPer: Integer;
    FCells: TChdDTimeItemList;
    procedure Read(Stream: TStreamReader; Unhandled: TStreamWriter;
...
constructor TChdDTimeItem.Create;
begin
  cellid.Initialize;
  head.Initialize;
...
destructor TChdDTimeItem.Destroy;
begin
  aux.Free;
  inherited;
end;
...
begin
  FCells := TChdDTimeItemList.Create;
  inherited;
end;
