...
begin
  ...
  begin
    ...
    begin
      SetLength(TGhbStorage(Boundaries[ItemIndex, AModel]).FGhbArray[Index].GwtConcentrations.Concentrations,
        LocalModel.MobileComponents.Count);
      SetLength(TGhbStorage(Boundaries[ItemIndex, AModel]).FGhbArray[Index].GwtConcentrations.ConcentrationAnnotations,
        LocalModel.MobileComponents.Count);
      SetLength(TGhbStorage(Boundaries[ItemIndex, AModel]).FGhbArray[Index].GwtConcentrations.ConcentrationPestNames,
        LocalModel.MobileComponents.Count);
      SetLength(TGhbStorage(Boundaries[ItemIndex, AModel]).FGhbArray[Index].GwtConcentrations.ConcentrationPestSeriesNames,
        LocalModel.MobileComponents.Count);
      SetLength(TGhbStorage(Boundaries[ItemIndex, AModel]).FGhbArray[Index].GwtConcentrations.ConcentrationPestSeriesMethods,
        LocalModel.MobileComponents.Count);
      SetLength(TGhbStorage(Boundaries[ItemIndex, AModel]).FGhbArray[Index].GwtConcentrations.ConcentrationTimeSeriesNames,
        LocalModel.MobileComponents.Count);
    end;
  end;
  inherited;
