...
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  ...
  file='SutraTest5.Middle_Permeability.PstValues')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
...
write_column_data_file(header='no', &
  file='arrays\SutraTest5.Middle_Permeability_1.arrays';delim="space", &
  plist=p_Value1)
write_column_data_file(header='no', &
  file='arrays\SutraTest5.Middle_Permeability_2.arrays';delim="space", &
  plist=p_Value2)
write_column_data_file(header='no', &
  file='arrays\SutraTest5.Middle_Permeability_3.arrays';delim="space", &
  plist=p_Value3)
