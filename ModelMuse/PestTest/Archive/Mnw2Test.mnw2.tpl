ptf @
etf %
# MNW2: Multi-Node Well package file created on 4/10/2024 by ModelMuse version 5.2.0.4.
...
THIEM      0     0     0     0 # Data Set 2B: LOSSTYPE, PUMPLOC, Qlimit, PPFLAG, PUMPCAP
 -1.000000000000E+000  # Data Set 2C; Rw
  0.000000000000E+000  -2.999999700000E+001      7     7 %                    1 *  @                    MnRw@%  # Data Set 2D; Ztop, Zbotm, ROW, COL, Rw
...
SKIN      0     0     0     0 # Data Set 2B: LOSSTYPE, PUMPLOC, Qlimit, PPFLAG, PUMPCAP
 -1.000000000000E+000  -1.000000000000E+000  -1.000000000000E+000  # Data Set 2C; Rw, Rskin, Kskin
  0.000000000000E+000  -4.999999500000E+000      8    17  4.000000000000E-001   1.000000000000E+000   1.000000000000E-003  # Data Set 2D; Ztop, Zbotm, ROW, COL, Rw, Rskin, Kskin
 -1.500000150000E+001  -2.499999750000E+001      8    17  4.000000000000E-001   8.000000000000E-001   1.000000000000E-003  # Data Set 2D; Ztop, Zbotm, ROW, COL, Rw, Rskin, Kskin
...
GENERAL      0     0     0     0 # Data Set 2B: LOSSTYPE, PUMPLOC, Qlimit, PPFLAG, PUMPCAP
 %                    1 *  @                    MnRw@%   1.000000000000E-001   1.000000000000E-001   2.000000000000E+000  # Data Set 2C; Rw, B, C, P
  0.000000000000E+000  -1.999999800000E+001      3    13 # Data Set 2D; Ztop, Zbotm, ROW, COL
...
SPECIFYcwc      0     0     0     0 # Data Set 2B: LOSSTYPE, PUMPLOC, Qlimit, PPFLAG, PUMPCAP
  ...
  0.000000000000E+000  -1.899999810000E+001      3    24 # Data Set 2D; Ztop, Zbotm, ROW, COL
