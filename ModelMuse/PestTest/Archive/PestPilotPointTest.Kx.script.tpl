...
# Setting values for layer     1
  # Setting values for parameter Hk1
    ...
    temp1=Hk1_1.krige_using_file(file='PestPilotPointTest.Kx.Factors1';form='formatted', &
      transform='log')
  ...
  # Setting values for parameter Hk2
    # Substituting interpolated values
    # Get interpolated values
    temp1=Hk2_1.krige_using_file(file='PestPilotPointTest.Kx.Factors2';form='formatted', &
      transform='log')
    # Write interpolated values in zones
...
# Setting values for layer     2
  # Setting values for parameter Hk1
    # Substituting interpolated values
    # Get interpolated values
    temp2=Hk1_2.krige_using_file(file='PestPilotPointTest.Kx.Factors3';form='formatted', &
      transform='log')
    # Write interpolated values in zones
  ...
  # Setting values for parameter Hk2
    # Substituting interpolated values
    # Get interpolated values
    temp2=Hk2_2.krige_using_file(file='PestPilotPointTest.Kx.Factors4';form='formatted', &
      transform='log')
    # Write interpolated values in zones
...
# Setting values for layer     3
  # Setting values for parameter Hk1
    # Substituting interpolated values
    # Get interpolated values
    temp3=Hk1_3.krige_using_file(file='PestPilotPointTest.Kx.Factors5';form='formatted', &
      transform='log')
    # Write interpolated values in zones
  ...
  # Setting values for parameter Hk2
    # Substituting interpolated values
    # Get interpolated values
    temp3=Hk2_3.krige_using_file(file='PestPilotPointTest.Kx.Factors6';form='formatted', &
      transform='log')
    # Write interpolated values in zones
