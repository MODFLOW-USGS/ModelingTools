...
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  ...
  file='SutraTest5.Minimum_Permeability.PstValues')
...
write_column_data_file(header='no', &
  file='arrays\SutraTest5.Minimum_Permeability_1.arrays';delim="space", &
  plist=p_Value1)
...
#Write new data values
write_column_data_file(header='no', &
  file='arrays\SutraTest5.Minimum_Permeability_2.arrays';delim="space", &
  plist=p_Value2)
...
#Write new data values
write_column_data_file(header='no', &
  file='arrays\SutraTest5.Minimum_Permeability_3.arrays';delim="space", &
  plist=p_Value3)
