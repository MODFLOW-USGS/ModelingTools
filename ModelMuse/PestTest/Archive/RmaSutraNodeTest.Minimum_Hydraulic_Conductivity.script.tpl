...
PMNPilotPoints1 = read_list_file(skiplines=0,dimensions=2, &
  plist='K_1';column=5, &
  id_type='character',file='RmaSutraNodeTest.Minimum_Hydraulic_Conductivity.K.1.pp')
...
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  ...
  file='RmaSutraNodeTest.Minimum_Hydraulic_Conductivity.PstValues')
...
# Setting values for layer     1
  # Setting values for parameter K
    ...
    temp1=K_1.krige_using_file(file='RmaSutraNodeTest.Minimum_Hydraulic_Conductivity.Factors1';form='formatted', &
      transform='log')
...
write_column_data_file(header='no', &
  file='arrays\RmaSutraNodeTest.Minimum_Hydraulic_Conductivity_1.arrays';delim="space", &
  plist=p_Value1)
