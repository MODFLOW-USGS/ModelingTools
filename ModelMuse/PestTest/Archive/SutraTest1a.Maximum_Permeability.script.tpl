...
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  ...
  file='SutraTest1a.Maximum_Permeability.PstValues')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
...
write_column_data_file(header='no', &
  file='arrays\SutraTest1a.Maximum_Permeability_1.arrays';delim="space", &
  plist=p_Value1)
write_column_data_file(header='no', &
  file='arrays\SutraTest1a.Maximum_Permeability_2.arrays';delim="space", &
  plist=p_Value2)
write_column_data_file(header='no', &
  file='arrays\SutraTest1a.Maximum_Permeability_3.arrays';delim="space", &
  plist=p_Value3)
