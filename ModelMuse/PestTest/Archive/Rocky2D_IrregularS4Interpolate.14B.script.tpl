...
COMPMA_PilotPoints1 = read_list_file(skiplines=0,dimensions=2, &
  ...
  id_type='character',file='Rocky2D_IrregularS4Interpolate.14B.SolidMatrixCompressibility.Density.1.pp')
COMPMA_PilotPoints2 = read_list_file(skiplines=0,dimensions=2, &
  plist='COMPMA_Density_2';column=5, &
  id_type='character',file='Rocky2D_IrregularS4Interpolate.14B.SolidMatrixCompressibility.Density.2.pp')
COMPMA_PilotPoints3 = read_list_file(skiplines=0,dimensions=2, &
  plist='COMPMA_Density_3';column=5, &
  id_type='character',file='Rocky2D_IrregularS4Interpolate.14B.SolidMatrixCompressibility.Density.3.pp')
...
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  ...
  file='Rocky2D_IrregularS4Interpolate.Unsat_Region_Nodes')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
...
# Read COMPMA
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  file='Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
...
# Read CS
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  file='Rocky2D_IrregularS4Interpolate.SolidGrain_SpecificHeat')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
...
# Read RHOS
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  file='Rocky2D_IrregularS4Interpolate.SolidGrainDensity')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
