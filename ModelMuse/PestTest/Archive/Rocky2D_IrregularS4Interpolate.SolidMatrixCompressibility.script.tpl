...
PilotPoints1 = read_list_file(skiplines=0,dimensions=2, &
  ...
  id_type='character',file='Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility.Density.1.pp')
PilotPoints2 = read_list_file(skiplines=0,dimensions=2, &
  plist='Density_2';column=5, &
  id_type='character',file='Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility.Density.2.pp')
PilotPoints3 = read_list_file(skiplines=0,dimensions=2, &
  plist='Density_3';column=5, &
  id_type='character',file='Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility.Density.3.pp')
...
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  ...
  file='Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility.PstValues')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
...
# Setting values for layer     1
  # Setting values for parameter Density
    ...
    temp1=Density_1.krige_using_file(file='Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility.Factors1';form='formatted', &
      transform='none')
...
# Setting values for layer     2
  # Setting values for parameter Density
    # Substituting interpolated values
    # Get interpolated values
    temp2=Density_2.krige_using_file(file='Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility.Factors2';form='formatted', &
      transform='none')
    # Write interpolated values in zones
...
# Setting values for layer     3
  # Setting values for parameter Density
    # Substituting interpolated values
    # Get interpolated values
    temp3=Density_3.krige_using_file(file='Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility.Factors3';form='formatted', &
      transform='none')
    # Write interpolated values in zones
...
write_column_data_file(header='no', &
  file='arrays\Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility_1.arrays';delim="space", &
  plist=p_Value1)
write_column_data_file(header='no', &
  file='arrays\Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility_2.arrays';delim="space", &
  plist=p_Value2)
write_column_data_file(header='no', &
  file='arrays\Rocky2D_IrregularS4Interpolate.SolidMatrixCompressibility_3.arrays';delim="space", &
  plist=p_Value3)
