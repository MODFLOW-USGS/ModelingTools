...
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  ...
  file='SutraTest1a.MyMult.PstValues')
...
write_column_data_file(header='no', &
  file='arrays\SutraTest1a.MyMult_1.arrays';delim="space", &
  plist=p_Value1)
...
#Write new data values
write_column_data_file(header='no', &
  file='arrays\SutraTest1a.MyMult_2.arrays';delim="space", &
  plist=p_Value2)
...
#Write new data values
write_column_data_file(header='no', &
  file='arrays\SutraTest1a.MyMult_3.arrays';delim="space", &
  plist=p_Value3)
...
#Write new data values
write_column_data_file(header='no', &
  file='arrays\SutraTest1a.MyMult_4.arrays';delim="space", &
  plist=p_Value4)
