...
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  ...
  file='Rocky2D_IrregularS4NoInterpolate.Unsat_Region_Nodes')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
...
# Read COMPMA
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  file='Rocky2D_IrregularS4NoInterpolate.SolidMatrixCompressibility')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
...
# Read CS
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  file='Rocky2D_IrregularS4NoInterpolate.SolidGrain_SpecificHeat')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
...
# Read RHOS
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  file='Rocky2D_IrregularS4NoInterpolate.SolidGrainDensity')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
