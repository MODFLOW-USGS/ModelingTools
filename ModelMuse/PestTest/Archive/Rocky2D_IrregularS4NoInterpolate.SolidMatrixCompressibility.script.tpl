...
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
  ...
  file='Rocky2D_IrregularS4NoInterpolate.SolidMatrixCompressibility.PstValues')
read_list_file(reference_clist='cl_Discretization',skiplines=1, &
...
write_column_data_file(header='no', &
  file='arrays\Rocky2D_IrregularS4NoInterpolate.SolidMatrixCompressibility_1.arrays';delim="space", &
  plist=p_Value1)
write_column_data_file(header='no', &
  file='arrays\Rocky2D_IrregularS4NoInterpolate.SolidMatrixCompressibility_2.arrays';delim="space", &
  plist=p_Value2)
write_column_data_file(header='no', &
  file='arrays\Rocky2D_IrregularS4NoInterpolate.SolidMatrixCompressibility_3.arrays';delim="space", &
  plist=p_Value3)
