...
function Cmplx(X, Y : Float) : Complex; external 'dmath';
{ Returns the complex number X + iY }

function Polar(R, Theta : Float) : Complex; external 'dmath';
{ Returns the complex number R * [cos(Theta) + i * sin(Theta)] }

function CReal(Z : Complex) : Float; external 'dmath';
{ Returns the real part of Z }

function CImag(Z : Complex) : Float; external 'dmath';
{ Returns the imaginary part of Z }

function CSgn(Z : Complex) : Integer; external 'dmath';
{ Complex sign }

procedure CSwap(var X, Y : Complex); external 'dmath';
{ Exchanges two complex numbers }

function CAbs(Z : Complex) : Float; external 'dmath';
{ Modulus of Z }

function CAbs2(Z : Complex) : Float; external 'dmath';
{ Squared modulus of Z }

function CArg(Z : Complex) : Float; external 'dmath';
{ Argument of Z }

function CConj(Z : Complex) : Complex; external 'dmath';
{ Complex conjugate }

function CNeg(Z : Complex) : Complex; external 'dmath';
{ Change sign }

function CAdd(A, B : Complex) : Complex; external 'dmath';
{ Complex addition }

function CSub(A, B : Complex) : Complex; external 'dmath';
{ Complex subtraction }

function CMul(A, B : Complex) : Complex; external 'dmath';
{ Complex multiplication }

function CSqr(Z : Complex) : Complex; external 'dmath';
{ Complex square }

function CDiv(A, B : Complex) : Complex; external 'dmath';
{ Complex division }

function CInv(Z : Complex) : Complex; external 'dmath';
{ Complex inverse }

function CSqrt(Z : Complex) : Complex; external 'dmath';
{ Principal part of complex square root }

function CLn(Z : Complex) : Complex; external 'dmath';
{ Principal part of complex logarithm }

function CExp(Z : Complex) : Complex; external 'dmath';
{ Complex exponential }

function CRoot(Z : Complex; K, N : Integer) : Complex; external 'dmath'; 
{ All N-th roots: Z^(1/N), K=0..N-1 }

function CPower(A, B : Complex) : Complex; external 'dmath';
{ Power with complex exponent }

function CIntPower(A : Complex; N : Integer) : Complex; external 'dmath';
{ Power with integer exponent }

function CRealPower(A : Complex; X : Float) : Complex; external 'dmath';
{ Power with real exponent }

function CPoly(Z : Complex; Coef : TVector; Deg : Integer) : Complex; external 'dmath';
{ Polynomial with real coefficients }

function CSin(Z : Complex) : Complex; external 'dmath';
{ Complex sine }

function CCos(Z : Complex) : Complex; external 'dmath';
{ Complex cosine }

procedure CSinCos(Z : Complex; var SinZ, CosZ : Complex); external 'dmath';
{ Complex sine and cosine }

function CTan(Z : Complex) : Complex; external 'dmath';
{ Complex tangent }

function CArcSin(Z : Complex) : Complex; external 'dmath';
{ Complex arc sine }

function CArcCos(Z : Complex) : Complex; external 'dmath';
{ Complex arc cosine }

function CArcTan(Z : Complex) : Complex; external 'dmath';
{ Complex arc tangent }

function CSinh(Z : Complex) : Complex; external 'dmath';
{ Complex hyperbolic sine }
 
function CCosh(Z : Complex) : Complex; external 'dmath';
{ Complex hyperbolic cosine }

procedure CSinhCosh(Z : Complex; var SinhZ, CoshZ : Complex); external 'dmath';
{ Complex hyperbolic sine and cosine }

function CTanh(Z : Complex) : Complex; external 'dmath'; 
{ Complex hyperbolic tangent }

function CArcSinh(Z : Complex) : Complex; external 'dmath';
{ Complex hyperbolic arc sine }

function CArcCosh(Z : Complex) : Complex; external 'dmath';
{ Complex hyperbolic arc cosine }

function CArcTanh(Z : Complex) : Complex; external 'dmath';
{ Complex hyperbolic arc tangent }

function CLnGamma(Z : Complex) : Complex; external 'dmath';
{ Logarithm of Gamma function }
...
procedure InitGen(Seed : Integer); external 'dmath';
{ Initialize generator }

function IRanGen : Integer; external 'dmath';
{ 32-bit random integer in [-2^31 .. 2^31 - 1] }

function IRanGen31 : Integer; external 'dmath';
...
procedure InitUVAG(Seed : Integer); external 'dmath';
{ Initializes the UVAG generator with an integer }

function IRanUVAG : Integer; external 'dmath';
...
procedure WriteLegendSelect({$IFDEF DELPHI}Canvas : TCanvas;{$ENDIF}
                            NSelect               : Integer;
                            Select                : TIntVector;
                            ShowPoints, ShowLines : Boolean);
external 'dmath';
...
procedure TeX_WriteLegendSelect(NSelect : Integer; Select : TIntVector; ShowPoints, ShowLines : Boolean); external 'dmath';
{ Writes legends for selected curves }
...
procedure HSVtoRGB(H, S, V : Float; var R, G, B : Byte); external 'dmath';
{ Converts HSV to RGB }

procedure RGBtoHSV(R, G, B : Byte; var H, S, V : Float); external 'dmath';
{ Converts RGB to HSV }
