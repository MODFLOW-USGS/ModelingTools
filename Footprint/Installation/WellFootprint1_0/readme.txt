...
The distribution files contain:
          ...
          WellFootprint documentation in PDF files.
...
2. Open a command-line window and type path for WellFootprint.exe optionally
   followed by the name of an input file for WellFootprint. If no input file
   is specified, the user is prompted to enter the name of the input file.  
