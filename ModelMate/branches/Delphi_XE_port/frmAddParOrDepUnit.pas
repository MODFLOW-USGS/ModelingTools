          ...
          case PDUse of
            pduParameter:
              for I := 0 to ParamSetCurrent.Count - 1 do
                begin
                  if AnsiSameText(edtParOrDepName.Text,ParamSetCurrent.Items[I].Name) then
                    IErr := 2;
                end;
            pduObservation:
              for I := 0 to DepSetTemp.Count - 1 do
                begin
                  if AnsiSameText(edtParOrDepName.Text,DepSetTemp.Items[I].Name) then
                    IErr := 2;
                end;
            pduPrediction:
              for I := 0 to DepSetTemp.Count - 1 do
            ...
            pduPrior:
              for I := 0 to PriSetTemp.Count - 1 do
                begin
                  if AnsiSameText(edtParOrDepName.Text,PriSetTemp.Items[I].Name) then
                    IErr := 2;
                end;
          ...
          case PDUse of
            pduParameter:
              begin
                ...
                ParamSetCurrent.Items[I].Initialize(edtParOrDepName.Text,
                                                    cmbGroup.Text);
              end;
            pduObservation:
              begin
                ...
                DepSetTemp.Items[I].Initialize(edtParOrDepName.Text,
                                                  cmbGroup.Text, dcObs);
//                ObservationsChanged := True;
            ...
            pduPrediction:
              begin
                ...
                I := DepSetTemp.Count - 1;
                DepSetTemp.Items[I].Initialize(edtParOrDepName.Text,
                                                   cmbGroup.Text, dcPred);
              end;
            pduPrior:
              begin
                PriSetTemp.Add;
                I := PriSetTemp.Count - 1;
                PriSetTemp.Items[I].Initialize(edtParOrDepName.Text,
                                                   cmbGroup.Text);
              end;
          end;
          ModalResult := mrOK;
      ...
      pduParameter:
        begin
          ...
          for I := 0 to ParamGpsCurrent.Count - 1 do
            begin
              Str := ParamGpsCurrent.Items[I].Name;
              GroupList.Add(Str);
            end;
