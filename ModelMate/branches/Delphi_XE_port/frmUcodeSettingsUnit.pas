  ...
  if KeepCurrent then
    begin
      ...
      begin
        ...
        ModelLengthUnits := cmbModelLenUnit.Text;;
        ModelTimeUnits := cmbModelTimeUnit.Text;
        ModelMassUnits := cmbModelMassUnit.Text;
...
begin
  edtModelName.Text := UcPrj.ModelName;
  cmbModelLenUnit.Text := UcPrj.ModelLengthUnits;
  cmbModelTimeUnit.Text := UcPrj.ModelTimeUnits;
  cmbModelMassUnit.Text := UcPrj.ModelMassUnits;
