...
begin
  ...
  if AnsiSameText(UcPrj.MaxChangeRealm,'Native') then
    cmbMaxChangeRealm.ItemIndex := 0
  else
    if AnsiSameText(UcPrj.MaxChangeRealm,'Regression') then
    ...
    begin
      ...
      if OK then
        begin
          ...
          MaxChangeRealm := cmbMaxChangeRealm.Text;
...
begin
  ...
  if SameText(UcPrj.TrustRegion, 'no') then
    begin
    ...
    begin
      ...
      if SameText(UcPrj.TrustRegion, 'dogleg') then
        begin
      ...
      if SameText(UcPrj.TrustRegion, 'hookstep') then
        begin
