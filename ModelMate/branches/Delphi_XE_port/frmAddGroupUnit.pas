          ...
          case GpUse of
            guParGroup:
              begin
                ...
                ParamGpsCurrent.Items[I].Initialize(GroupName, GroupName);
                Close;
              end;
            guObsGroup:
              begin
                ...
                DepGpsTemp.Items[I].Initialize(GroupName, GroupName, dcObs);
                Close;
              end;
            guPredGroup:
              begin
                DepGpsTemp.Add;
                I := DepGpsTemp.Count - 1;
                DepGpsTemp.Items[I].Initialize(GroupName, GroupName, dcPred);
                Close;
              end;
            guPriGroup:
              begin
                ...
                PriGpsTemp.Items[I].Initialize(GroupName, GroupName);
                Close;
              end;
            guUnknown: ;
          end;
          ...
          guParGroup:
            begin
              for I := 0 to ParamGpsCurrent.Count - 1 do
                begin
                  if AnsiSameText(edtGpName.Text,ParamGpsCurrent.Items[I].Name) then
                    IErr := 2;
                end;
            end;
          guObsGroup:
            begin
              for I := 0  to DepGpsTemp.Count - 1 do
                begin
                  if AnsiSameText(edtGpName.Text,DepGpsTemp.Items[I].Name) then
                    IErr := 2;
                end;
            end;
          guPredGroup:
          ...
          guPriGroup:
            begin
              for I := 0  to PriGpsTemp.Count - 1 do
                begin
                  if AnsiSameText(edtGpName.Text,PriGpsTemp.Items[I].Name) then
                    IErr := 2;
                end;
            end;
          guUnknown: ;
        ...
        case GpUse of
          guParGroup:
            begin
              ParamGpsCurrent.Add;
              I := ParamGpsCurrent.Count - 1;
              ParamGpsCurrent.Items[I].Initialize(edtGpName.Text, edtGpName.Text);
              Close;
            end;
          guObsGroup:
            begin
              DepGpsTemp.Add;
              I := DepGpsTemp.Count - 1;
              DepGpsTemp.Items[I].Initialize(edtGpName.Text, edtGpName.Text, dcObs);
              Close;
            end;
          guPredGroup:
            begin
              DepGpsTemp.Add;
              I := DepGpsTemp.Count - 1;
              DepGpsTemp.Items[I].Initialize(edtGpName.Text, edtGpName.Text, dcPred);
              Close;
            end;
          guPriGroup:
            begin
              PriGpsTemp.Add;
              I := PriGpsTemp.Count - 1;
              PriGpsTemp.Items[I].Initialize(edtGpName.Text, edtGpName.Text);
              Close;
            end;
          guUnknown: ;
        end
