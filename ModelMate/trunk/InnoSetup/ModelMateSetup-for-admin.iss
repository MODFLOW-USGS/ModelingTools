...
InfoBeforeFile=D:\Delphi_Projects\ModelMate\ModelMate_1_0_3\release.txt
OutputDir=D:\Delphi_Projects\ModelMate\InnoSetup\Compiler_output
OutputBaseFilename=ModelMate_install_{#MyAppVersion}
...
;Source: "D:\Delphi_Projects\ModelMate\ModelMate_1_0_3\Bin\ModelMate.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "D:\Delphi_Projects\ModelMate\ModelMate_1_0_3\*"; DestDir: "C:\WRDAPP\{#MyAppVerName}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
[Run]
Filename: "{app}\bin\{#MyAppExeName}"; Description: "{cm:LaunchProgram,ModelMate}"; Flags: nowait postinstall skipifsilent
