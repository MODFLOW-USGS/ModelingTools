...
type
  ...
  private
    ...
    Modflow2005LocationOnShow: TFileName;
...
begin
  ...
  if Modflow2005Location <> Modflow2005LocationOnShow then
    begin
      Messg := 'You have changed the location of the MODFLOW-2005 executable file.  ' +
      'You also may want to revise the command(s) for the forward primary and ' +
      'predictive model runs in the Model Commands window.';
      ShowMessage(Messg);
    end;
end;
...
begin
  ...
  Modflow2005LocationOnShow := Modflow2005Location;
