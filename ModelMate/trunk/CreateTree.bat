...
copy ..\Release\ModelMate.exe bin
copy ..\Release\accjupiter.dll bin
REM copy ..\M_icon3.ico .
REM copy ..\FastMM_FullDebugMode.dll bin
copy C:\WRDAPP\MF2005.1_11\bin\mf2005.exe bin
copy C:\WRDAPP\ucode_2014_1.003_and_more\UCODE_2014_1.003\bin\ucode_2014.exe bin
...
copy ..\ModelMate_tutorial.pdf Doc
...
echo where Directory-name is of form: ModelMate_0_27_0
