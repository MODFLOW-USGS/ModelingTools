...
USE UTLUCODE
  ...
  480 FORMAT (30X,'MODEL_LINEARITY_ADV',//, &
      ...
      15X,'UCODE_2005 POST-PROCESSING PROGRAM TO CALCULATE',/, &
  ...
  485 FORMAT (//, &
   ...
   5X,'GENERATED BY UCODE_2005 WHEN IT IS EXECUTED WITH LINEARITYADV=yes',/, &
