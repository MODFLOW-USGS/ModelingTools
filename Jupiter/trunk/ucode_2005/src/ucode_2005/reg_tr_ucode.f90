...
!=======================================================================
!======================================================================
   SUBROUTINE REG_TR_GEN (IFAIL,MPR,NOBS,NEOBS,NDOBS,NPE,NPS,IOUT,CSS, &
...
!
    ...
    IF(STEPTYPE .EQ. 'DOGLEG') &
      CALL REG_TR_DOGDRIVE(MPR,NDOBS,NEOBS,NOBS,NPE,NPERD,NPS, &
    ...
    IF(STEPTYPE .EQ. 'HOOKSTEP') &
      CALL REG_TR_HOOKDRIVE(MPR,NDOBS,NEOBS,NOBS,NPE,NPERD,NPS, &
