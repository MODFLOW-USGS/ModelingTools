...
!=======================================================================
!=======================================================================
  SUBROUTINE REG_TR_DOGDRIVE(MPR,NDOBS,NEOBS,NOBS,NPE,N,NPS, &
    ...
    DO WHILE (RETCODE .GE. 2)
      ...
      CALL TRUSTUP(MPR,N,NDOBS,NEOBS,NEWTTAKEN,NOBS,NPE,NPS, &
...
!=======================================================================
!=======================================================================
  SUBROUTINE REG_TR_HOOKDRIVE(MPR,NDOBS,NEOBS,NOBS,NPE,N,NPS, &
...
!=======================================================================
!=======================================================================
  SUBROUTINE TRUSTUP(MPR,N,NDOBS,NEOBS,NEWTTAKEN,NOBS,NPE,NPS, &
                     FC,G,H,IOUT,IPTR,L,LN,MAXSTEP,NPTR,PARNAM, &
                     PTOLPAR,S,SCLE,STEPTYPE,XPTR,FPREV,MODVALPREV,R, &
                     XC,XNPE,XPREV,FPLUS,MAXTAKEN,RETCODE,XPLUS)
    ...
    ENDDO
    !
    CALL GETOBJFCN(MPR,NDOBS,NEOBS,NOBS,NPE,NPS,XNPE,FPLUS)
    !END NOTE:
...
!=======================================================================
!=======================================================================
  SUBROUTINE GETOBJFCN(MPR,NDOBS,NEOBS,NOBS,NPE,NPS,PVAL,FPLUS)
    !
...
!    DOUBLE PRECISION                             :: MODELVAL(NDOBS)
    ...
    CALL UCODE_GEN_PVALALL(IFAIL,0,PVAL,PVALTMP)
    !
