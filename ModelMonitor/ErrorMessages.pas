...
//    ErrorValues.Add('IS GREATER THAN');
    ...
    ErrorValues.Add('Negative cell thickness at');
...
//    ErrorValues.Add('ERROR.');
    ...
    ErrorValues.Add('Error.  GWF-GWF requires that');
    ErrorValues.Add('NOT CONSISTENT WITH GNC NODES');
    ErrorValues.Add('Error: Boundary');
    ErrorValues.Add('CONVERGENCE FAILED');
    ErrorValues.Add('KEYWORD MUST BE FOLLOWED BY');
    ErrorValues.Add('ERROR. cg_SKE GRIDDATA MUST BE SPECIFIED');
    ErrorValues.Add('ERROR. cg_THETA GRIDDATA MUST BE SPECIFIED');
    ErrorValues.Add('ERROR. COARSE-GRAINED MATERIAL cg_ske_cr');
    ErrorValues.Add('ERROR. COARSE-GRAINED MATERIAL THETA');
    ErrorValues.Add('ERROR. SPECIFIC STORAGE VALUES IN THE STORAGE (STO) PACKAGE MUST');
    ErrorValues.Add('ERROR. AQUIFER THICKNESS IS LESS THAN ZERO');
    ErrorValues.Add('ERROR: SMALL TO NEGATIVE EFFECTIVE STRESS');
    ErrorValues.Add('ERROR SOLUTION: SMALL TO NEGATIVE EFFECTIVE STRESS VALUES IN');
    ErrorValues.Add('ERROR: HEAD');
    ErrorValues.Add('cell must be > 0 and ');
    ErrorValues.Add('Based on node numbering rules');
    ErrorValues.Add('Error:');
    ErrorValues.Add('K33OVERK option specified but K33 not specified');
    ErrorValues.Add('K22OVERK option specified but K22 not specified');
    ErrorValues.Add('additional errors not shown for');
    ErrorValues.Add('is <= 0 for cell');
    ErrorValues.Add('When READASARRAYS is specified for the selected discretization');
    ErrorValues.Add('DETECTED TIME STEP LENGTH OF ZERO');
    ErrorValues.Add('Error in SS DATA: SS value in cell');
    ErrorValues.Add('Error in SY DATA: SY value in cell');
    ErrorValues.Add('Program error: DisBaseType method');
    ErrorValues.Add('ERROR. MXITER IS SET TO');
    ErrorValues.Add('ERROR. INVALID MODEL NAME');
    ErrorValues.Add('EXCEEDS MAXIMUM LENGTH OF');
    ErrorValues.Add('MODEL NAME CANNOT HAVE SPACES WITHIN IT');
    ErrorValues.Add('SLN_AR: OUTER_RCLOSEBND MUST');
    ErrorValues.Add('NUMBER OF TIME STEPS LESS THAN ONE');
    ErrorValues.Add('illegal option');
    ErrorValues.Add('is not present in working ');
    ErrorValues.Add('*** ERROR OPENING FILE');
    ErrorValues.Add('*** FILE ALREADY OPEN ON UNIT:');
    ErrorValues.Add('SPECIFIED FILE STATUS:');
    ErrorValues.Add('-- STOP EXECUTION (openfile');
    ErrorValues.Add('Error reported as:');
    ErrorValues.Add('Package type not supported:');
    ErrorValues.Add('Programming error in ListType');
    ErrorValues.Add('Specified OPEN/CLOSE file');
    ErrorValues.Add('ERROR READING LIST FROM FILE');
    ErrorValues.Add('Error reading PACKAGES from file');
    ErrorValues.Add('SAVE FILE MUST BE SPECIFIED IN OUTPUT CONTROL OPTIONS');
    ErrorValues.Add('errors detected.');
...
//    WarningValues.Add('K22 not provided.  Assuming K22 = K.');
    ...
    WarningValues.Add('EFFECTIVE_STRESS_LAG HAS BEEN SPECIFIED BUT HAS NO EFFECT WHEN USING');
//    WarningValues.Add('THE SPECIFIED IDOMAIN RESULTS IN A REDUCED NUMBER OF CELLS');
    WarningValues.Add('ANGLDEGX NOT FOUND IN CONNECTIONDATA');
