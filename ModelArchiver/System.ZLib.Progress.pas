...
//    function Write(const Buffer: TStream; Count: Longint): Longint; overload;
  end;
...
//function TZCompressionStream2.Write(const Buffer: TStream; Count: Longint): Longint;
//begin
