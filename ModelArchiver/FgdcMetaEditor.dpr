...
uses
  ...
  frmAboutFgdcMetaEditor in 'frmAboutFgdcMetaEditor.pas' {frmAboutMetaEditor};
...
{$IFDEF DEBUG}
  ...
  Application.CreateForm(TfrmAboutMetaEditor, frmAboutMetaEditor);
