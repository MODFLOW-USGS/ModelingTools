...
// (DO NOT EDIT: machine generated header) 'GLSceneRegister.pas' rev: 35.00 (Windows)
...
protected:
	System::Uitypes::TColor __fastcall ColorToBorderColor(const Glvectortypes::TVector4f &aColor, bool selected);
