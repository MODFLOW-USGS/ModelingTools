...
// (DO NOT EDIT: machine generated header) 'fmod.pas' rev: 35.00 (Windows)
...
extern DELPHI_PACKAGE void * __stdcall FSOUND_Stream_Create(Fmodtypes::TFSoundStreamCallback Callback, int Length, unsigned Mode, int SampleRate, int UserData);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall FSOUND_Stream_SetEndCallback(void * Stream, Fmodtypes::TFSoundStreamCallback Callback, int UserData);
extern DELPHI_PACKAGE System::ByteBool __stdcall FSOUND_Stream_SetSyncCallback(void * Stream, Fmodtypes::TFSoundStreamCallback Callback, int UserData);
extern DELPHI_PACKAGE void * __stdcall FSOUND_Stream_GetSample(void * Stream);
extern DELPHI_PACKAGE void * __stdcall FSOUND_Stream_CreateDSP(void * Stream, Fmodtypes::TFSoundDSPCallback Callback, int Priority, int Param);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall FSOUND_Stream_GetTagField(void * Stream, int Num, Fmodtypes::TFSoundTagFieldType &TagType, char * &Name, void * &Value, int &Length);
extern DELPHI_PACKAGE System::ByteBool __stdcall FSOUND_Stream_FindTagField(void * Stream, Fmodtypes::TFSoundTagFieldType TagType, char * Name, void * &Value, int &Length);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall FSOUND_Stream_Net_SetMetadataCallback(void * Stream, Fmodtypes::TFMetaDataCallback Callback, int UserData);
extern DELPHI_PACKAGE System::ByteBool __stdcall FSOUND_Stream_Net_GetStatus(void * Stream, Fmodtypes::TFSoundStreamNetStatus &Status, int &BufferPercentUsed, int &BitRate, unsigned &Flags);
...
extern DELPHI_PACKAGE void * __stdcall FSOUND_DSP_Create(Fmodtypes::TFSoundDSPCallback Callback, int Priority, int Param);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall FMUSIC_SetZxxCallback(void * Module, Fmodtypes::TFMusicCallback Callback);
extern DELPHI_PACKAGE System::ByteBool __stdcall FMUSIC_SetRowCallback(void * Module, Fmodtypes::TFMusicCallback Callback, int RowStep);
extern DELPHI_PACKAGE System::ByteBool __stdcall FMUSIC_SetOrderCallback(void * Module, Fmodtypes::TFMusicCallback Callback, int OrderStep);
extern DELPHI_PACKAGE System::ByteBool __stdcall FMUSIC_SetInstCallback(void * Module, Fmodtypes::TFMusicCallback Callback, int Instrument);
...
extern DELPHI_PACKAGE Fmodtypes::TFMusicTypes __stdcall FMUSIC_GetType(void * Module);
