...
// (DO NOT EDIT: machine generated header) 'GLDCEMisc.pas' rev: 35.00 (Windows)
...
extern DELPHI_PACKAGE void __fastcall ECAddBox(Glellipsecollision::TECMovePack &MovePack, Glscene::TGLBaseSceneObject* BoxObj, const Glvectortypes::TVector3f &BoxSize, bool Solid, int ObjectID);
...
extern DELPHI_PACKAGE void __fastcall ECAddEllipsoid(Glellipsecollision::TECMovePack &MovePack, const Glvectortypes::TVector3f &ePos, const Glvectortypes::TVector3f &eRadius, bool Solid, int ObjectID);
}	/* namespace Gldcemisc */
