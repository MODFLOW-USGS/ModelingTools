...
// (DO NOT EDIT: machine generated header) 'GLCanvas.pas' rev: 34.00 (Windows)
...
private:
	...
	int FBufferSizeY;
	int FLastPrimitive;
	Glvectortypes::TVector3f FCurrentPos;
	System::Uitypes::TColor FPenColor;
	int FPenWidth;
	Glvectortypes::TVector4f FCurrentPenColorVector;
...
public:
	__fastcall TGLCanvas(int bufferSizeX, int bufferSizeY, const Glvectortypes::TMatrix4f &baseTransform)/* overload */;
	...
	void __fastcall FillRectGradient(const float x1, const float y1, const float x2, const float y2, const Glvectortypes::TVector4f &x1y1Color, const Glvectortypes::TVector4f &x2y1Color, const Glvectortypes::TVector4f &x2y2Color, const Glvectortypes::TVector4f &x1y2Color)/* overload */;
	void __fastcall FillRectGradient(const int x1, const int y1, const int x2, const int y2, const Glvectortypes::TVector4f &x1y1Color, const Glvectortypes::TVector4f &x2y1Color, const Glvectortypes::TVector4f &x2y2Color, const Glvectortypes::TVector4f &x1y2Color)/* overload */;
	...
	void __fastcall FillEllipseGradient(const float x, const float y, const float xRadius, const float yRadius, const Glvectortypes::TVector4f &edgeColor)/* overload */;
	void __fastcall FillEllipseGradient(const int x, const int y, const int xRadius, const int yRadius, const Glvectortypes::TVector4f &edgeColor)/* overload */;
	void __fastcall FillEllipseGradient(const float x, const float y, const float Radius, const Glvectortypes::TVector4f &edgeColor)/* overload */;
