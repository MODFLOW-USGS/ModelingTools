...
// (DO NOT EDIT: machine generated header) 'OpenGLTokens.pas' rev: 35.00 (Windows)
...
typedef void __stdcall (*PFNGLSHADERSOURCEPROC)(unsigned shader, int count, const PGLPCharArray _string, const System::PInteger length);
...
typedef int __stdcall (*PFNWGLCREATEPBUFFERARBPROC)(HDC DC, int iPixelFormat, int iWidth, int iHeight, const System::PInteger piAttribList);
...
typedef System::LongBool __stdcall (*PFNWGLDESTROYPBUFFERARBPROC)(int hPbuffer);

typedef System::LongBool __stdcall (*PFNWGLQUERYPBUFFERARBPROC)(int hPbuffer, int iAttribute, System::PInteger piValue);

typedef System::LongBool __stdcall (*PFNWGLBINDTEXIMAGEARBPROC)(int hPbuffer, int iBuffer);

typedef System::LongBool __stdcall (*PFNWGLRELEASETEXIMAGEARBPROC)(int hpBuffer, int iBuffer);

typedef System::LongBool __stdcall (*PFNWGLSETPBUFFERATTRIBARBPROC)(int hpBuffer, const System::PInteger piAttribList);
...
typedef void __stdcall (*PFNGLSHADERSOURCEARBPROC)(unsigned shaderObj, int count, const PGLPCharArray _string, const System::PInteger length);
...
typedef void __stdcall (*PFNGLGETATTACHEDOBJECTSARBPROC)(unsigned containerObj, int maxCount, System::PInteger count, PGLhandleARB obj);
...
typedef void __stdcall (*PFNGLGETUNIFORMINDICESPROC)(unsigned _program, int uniformCount, PGLPCharArray uniformNames, System::PCardinal uniformIndices);
...
typedef NativeInt __stdcall (*PFNGLCreateSyncFromCLevent)(p_cl_context context, p_cl_event event, unsigned flags);
...
typedef System::ByteBool __stdcall (*PFNGLARETEXTURESRESIDENTEXTPROC)(int n, System::PCardinal textures, PGLboolean residences);
...
typedef void __stdcall (*PFNGLAREPROGRAMSRESIDENTNVPROC)(int n, System::PCardinal programs, PGLboolean residences);
