...
// (DO NOT EDIT: machine generated header) 'Q3MD3.pas' rev: 34.00 (Windows)
...
public:
	...
	Glvectortypes::TMatrix4f __fastcall GetTransform(const System::UnicodeString TagName, int Frame);
