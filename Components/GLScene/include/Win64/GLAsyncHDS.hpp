...
// (DO NOT EDIT: machine generated header) 'GLAsyncHDS.pas' rev: 34.00 (Windows)
...
public:
	...
	/* TThread.Create */ inline __fastcall TGLAsyncHDThread(bool CreateSuspended, NativeUInt ReservedStackSize)/* overload */ : Glheightdata::TGLHeightDataThread(CreateSuspended, ReservedStackSize) { }
