...
// (DO NOT EDIT: machine generated header) 'GLSpline.pas' rev: 35.00 (Windows)
...
public:
	__fastcall TCubicSpline(const Glvectorgeometry::PFloatVector X, const Glvectorgeometry::PFloatVector Y, const Glvectorgeometry::PFloatVector Z, const Glvectorgeometry::PFloatVector W, const int nb);
	...
	Glvectortypes::TVector3f __fastcall SplineAffineVector(const float t)/* overload */;
	void __fastcall SplineAffineVector(const float t, Glvectortypes::TVector3f &vector)/* overload */;
	Glvectortypes::TVector4f __fastcall SplineVector(const float t)/* overload */;
	void __fastcall SplineVector(const float t, Glvectortypes::TVector4f &vector)/* overload */;
	...
	Glvectortypes::TVector3f __fastcall SplineSlopeVector(const float t)/* overload */;
