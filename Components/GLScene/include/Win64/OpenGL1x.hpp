...
// (DO NOT EDIT: machine generated header) 'OpenGL1x.pas' rev: 35.00 (Windows)
...
extern "C" System::ByteBool __stdcall glAreTexturesResident(int n, PGLuint Textures, PGLboolean residences);
...
extern "C" void __stdcall glDeleteTextures(int n, PGLuint textures);
...
extern "C" void __stdcall glGenTextures(int n, PGLuint textures);
...
extern "C" void __stdcall glGetTexLevelParameteriv(unsigned target, int level, unsigned pname, PGLint params);
...
extern "C" void __stdcall glPixelMapuiv(unsigned map, int mapsize, PGLuint values);
...
extern "C" void __stdcall glPrioritizeTextures(int n, PGLuint textures, PGLclampf priorities);
...
extern "C" void __stdcall glSelectBuffer(int size, PGLuint buffer);
...
extern "C" void __stdcall gluCylinder(PGLUQuadric quadObject, double baseRadius, double topRadius, double height, int slices, int stacks);
...
extern "C" void __stdcall gluDisk(PGLUQuadric quadObject, double innerRadius, double outerRadius, int slices, int loops);
...
extern "C" void __stdcall gluGetNurbsProperty(PGLUNurbs nobj, unsigned aproperty, System::PSingle value);
extern "C" void __stdcall gluGetTessProperty(PGLUTesselator tess, unsigned which, System::PDouble value);
...
extern "C" void __stdcall gluNurbsCurve(PGLUNurbs nobj, int nknots, System::PSingle knot, int stride, System::PSingle ctlarray, int order, unsigned atype);
extern "C" void __stdcall gluNurbsProperty(PGLUNurbs nobj, unsigned aproperty, float value);
extern "C" void __stdcall gluNurbsSurface(PGLUNurbs nobj, int sknot_count, System::PSingle sknot, int tknot_count, System::PSingle tknot, int s_stride, int t_stride, System::PSingle ctlarray, int sorder, int torder, unsigned atype);
extern "C" void __stdcall gluOrtho2D(double left, double right, double bottom, double top);
extern "C" void __stdcall gluPartialDisk(PGLUQuadric quadObject, double innerRadius, double outerRadius, int slices, int loops, double startAngle, double sweepAngle);
...
extern "C" void __stdcall gluPwlCurve(PGLUNurbs nobj, int count, System::PSingle points, int stride, unsigned atype);
...
extern "C" void __stdcall gluQuadricTexture(PGLUQuadric quadObject, System::ByteBool textureCoords);
extern "C" void __stdcall gluSphere(PGLUQuadric quadObject, double radius, int slices, int stacks);
...
extern "C" void __stdcall gluTessNormal(PGLUTesselator tess, double x, double y, double z);
extern "C" void __stdcall gluTessProperty(PGLUTesselator tess, unsigned which, double value);
...
extern DELPHI_PACKAGE void __stdcall (*glTexSubImage3D)(unsigned target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, unsigned format, unsigned Atype, void * pixels);
...
extern DELPHI_PACKAGE void __stdcall (*glColorTableParameterfv)(unsigned target, unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glGetColorTableParameterfv)(unsigned target, unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glConvolutionParameterfv)(unsigned target, unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glGetConvolutionParameterfv)(unsigned target, unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glGetHistogram)(unsigned target, System::ByteBool reset, unsigned format, unsigned Atype, void * values);
extern DELPHI_PACKAGE void __stdcall (*glGetHistogramParameterfv)(unsigned target, unsigned pname, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetHistogramParameteriv)(unsigned target, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetMinmax)(unsigned target, System::ByteBool reset, unsigned format, unsigned Atype, void * values);
extern DELPHI_PACKAGE void __stdcall (*glGetMinmaxParameterfv)(unsigned target, unsigned pname, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetMinmaxParameteriv)(unsigned target, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glHistogram)(unsigned target, int width, unsigned internalformat, System::ByteBool sink);
extern DELPHI_PACKAGE void __stdcall (*glMinmax)(unsigned target, unsigned internalformat, System::ByteBool sink);
...
extern DELPHI_PACKAGE void __stdcall (*glSampleCoverage)(float Value, System::ByteBool invert);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexImage3D)(unsigned target, int level, unsigned internalformat, int Width, int Height, int depth, int border, int imageSize, void * data);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexImage2D)(unsigned target, int level, unsigned internalformat, int Width, int Height, int border, int imageSize, void * data);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexImage1D)(unsigned target, int level, unsigned internalformat, int Width, int border, int imageSize, void * data);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexSubImage3D)(unsigned target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, unsigned Format, int imageSize, void * data);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexSubImage2D)(unsigned target, int level, int xoffset, int yoffset, int width, int height, unsigned Format, int imageSize, void * data);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexSubImage1D)(unsigned target, int level, int xoffset, int width, unsigned Format, int imageSize, void * data);
...
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord1dV)(unsigned target, System::PDouble v);
...
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord2dv)(unsigned target, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord2f)(unsigned target, float s, float t);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord2fv)(unsigned target, System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord3dv)(unsigned target, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord3f)(unsigned target, float s, float t, float r);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord3fv)(unsigned target, System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord4dv)(unsigned target, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord4f)(unsigned target, float s, float t, float r, float q);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord4fv)(unsigned target, System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glLoadTransposeMatrixf)(System::PSingle m);
extern DELPHI_PACKAGE void __stdcall (*glLoadTransposeMatrixd)(System::PDouble m);
extern DELPHI_PACKAGE void __stdcall (*glMultTransposeMatrixf)(System::PSingle m);
extern DELPHI_PACKAGE void __stdcall (*glMultTransposeMatrixd)(System::PDouble m);
...
extern DELPHI_PACKAGE void __stdcall (*glMultiDrawArrays)(unsigned mode, PGLint First, PGLsizei Count, int primcount);
extern DELPHI_PACKAGE void __stdcall (*glMultiDrawElements)(unsigned mode, PGLsizei Count, unsigned AType, void *indices, int primcount);
extern DELPHI_PACKAGE void __stdcall (*glPointParameterf)(unsigned pname, float param);
extern DELPHI_PACKAGE void __stdcall (*glPointParameterfv)(unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glFogCoordfv)(System::PSingle coord);
extern DELPHI_PACKAGE void __stdcall (*glFogCoordd)(double coord);
extern DELPHI_PACKAGE void __stdcall (*glFogCoorddv)(System::PDouble coord);
extern DELPHI_PACKAGE void __stdcall (*glFogCoordPointer)(unsigned AType, int stride, void * p);
...
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColor3dv)(System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColor3f)(float red, float green, float blue);
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColor3fv)(System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColor3ubv)(System::PByte v);
...
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColor3usv)(System::PWord v);
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColorPointer)(int Size, unsigned Atype, int stride, void * p);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos2d)(double x, double y);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos2dv)(System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos2f)(float x, float y);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos2fv)(System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glWindowPos3dv)(System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos3f)(float x, float y, float z);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos3fv)(System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glGenQueries)(int n, PGLuint ids);
extern DELPHI_PACKAGE void __stdcall (*glDeleteQueries)(int n, const PGLuint ids);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsQuery)(unsigned id);
...
extern DELPHI_PACKAGE void __stdcall (*glGetQueryObjectiv)(unsigned id, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetQueryObjectuiv)(unsigned id, unsigned pname, PGLuint params);
...
extern DELPHI_PACKAGE void __stdcall (*glAttachShader)(unsigned _program, unsigned shader);
extern DELPHI_PACKAGE void __fastcall (*glBindAttribLocation)(unsigned _program, unsigned index, const char * name);
...
extern DELPHI_PACKAGE void __stdcall (*glDeleteProgram)(unsigned _program);
extern DELPHI_PACKAGE void __stdcall (*glDeleteShader)(unsigned shader);
extern DELPHI_PACKAGE void __stdcall (*glDetachShader)(unsigned _program, unsigned shader);
...
extern DELPHI_PACKAGE void __stdcall (*glGetActiveAttrib)(unsigned _program, unsigned index, int bufSize, PGLsizei length, PGLint size, PGLenum _type, char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveUniform)(unsigned _program, unsigned index, int bufSize, PGLsizei length, PGLint size, PGLenum _type, char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetAttachedShaders)(unsigned _program, int maxCount, PGLsizei count, PGLuint obj);
extern DELPHI_PACKAGE int __stdcall (*glGetAttribLocation)(unsigned _program, const char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramiv)(unsigned _program, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramInfoLog)(unsigned _program, int bufSize, PGLsizei length, char * infoLog);
extern DELPHI_PACKAGE void __stdcall (*glGetShaderiv)(unsigned shader, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetShaderInfoLog)(unsigned shader, int bufSize, PGLsizei length, char * infoLog);
extern DELPHI_PACKAGE void __stdcall (*glGetShaderSource)(unsigned shader, int bufSize, PGLsizei length, char * source);
extern DELPHI_PACKAGE int __stdcall (*glGetUniformLocation)(unsigned _program, const char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetUniformfv)(unsigned _program, int location, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetUniformiv)(unsigned _program, int location, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribdv)(unsigned index, unsigned pname, System::PDouble params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribfv)(unsigned index, unsigned pname, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribiv)(unsigned index, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribPointerv)(unsigned index, unsigned pname, void * _pointer);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsProgram)(unsigned _program);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsShader)(unsigned shader);
extern DELPHI_PACKAGE void __stdcall (*glLinkProgram)(unsigned _program);
extern DELPHI_PACKAGE void __stdcall (*glShaderSource)(unsigned shader, int count, const PGLPCharArray _string, const PGLint length);
extern DELPHI_PACKAGE void __stdcall (*glUseProgram)(unsigned _program);
...
extern DELPHI_PACKAGE void __stdcall (*glUniform1fv)(int location, int count, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniform2fv)(int location, int count, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniform3fv)(int location, int count, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniform4fv)(int location, int count, System::PSingle value);
...
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix2fv)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix3fv)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix4fv)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glValidateProgram)(unsigned _program);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1d)(unsigned index, double x);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1dv)(unsigned index, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1f)(unsigned index, float x);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1fv)(unsigned index, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1s)(unsigned index, short x);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1sv)(unsigned index, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2d)(unsigned index, double x, double y);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2dv)(unsigned index, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2f)(unsigned index, float x, float y);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2fv)(unsigned index, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2s)(unsigned index, short x, short y);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2sv)(unsigned index, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3d)(unsigned index, double x, double y, double z);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3dv)(unsigned index, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3f)(unsigned index, float x, float y, float z);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3fv)(unsigned index, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3s)(unsigned index, short x, short y, short z);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3sv)(unsigned index, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4Nbv)(unsigned index, PGLbyte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4Niv)(unsigned index, PGLint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4Nsv)(unsigned index, PGLshort v);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4Nubv)(unsigned index, System::PByte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4Nuiv)(unsigned index, PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4Nusv)(unsigned index, System::PWord v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4bv)(unsigned index, PGLbyte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4d)(unsigned index, double x, double y, double z, double w);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4dv)(unsigned index, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4f)(unsigned index, float x, float y, float z, float w);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4fv)(unsigned index, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4iv)(unsigned index, PGLint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4s)(unsigned index, short x, short y, short z, short w);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4sv)(unsigned index, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4ubv)(unsigned index, System::PByte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4uiv)(unsigned index, PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4usv)(unsigned index, System::PWord v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribPointer)(unsigned index, int size, unsigned _type, System::ByteBool normalized, int stride, void * _pointer);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix2x3fv)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix3x2fv)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix2x4fv)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix4x2fv)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix3x4fv)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix4x3fv)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glColorMaski)(unsigned index, System::ByteBool r, System::ByteBool g, System::ByteBool b, System::ByteBool a);
extern DELPHI_PACKAGE void __stdcall (*glGetBooleani_v)(unsigned target, unsigned index, PGLboolean data);
extern DELPHI_PACKAGE void __stdcall (*glGetIntegeri_v)(unsigned target, unsigned index, PGLint data);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsEnabledi)(unsigned target, unsigned index);
...
extern DELPHI_PACKAGE void __stdcall (*glTransformFeedbackVaryings)(unsigned _program, int count, const PGLPCharArray varyings, unsigned bufferMode);
extern DELPHI_PACKAGE void __stdcall (*glGetTransformFeedbackVarying)(unsigned _program, unsigned index, int bufSize, PGLsizei length, PGLsizei size, PGLenum _type, char * name);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI1iv)(unsigned index, PGLint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI2iv)(unsigned index, PGLint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI3iv)(unsigned index, PGLint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4iv)(unsigned index, PGLint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI1uiv)(unsigned index, PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI2uiv)(unsigned index, PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI3uiv)(unsigned index, PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4uiv)(unsigned index, PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4bv)(unsigned index, PGLbyte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4sv)(unsigned index, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4ubv)(unsigned index, System::PByte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4usv)(unsigned index, System::PWord v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribIPointer)(unsigned index, int size, unsigned _type, int stride, void * _pointer);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribIiv)(unsigned index, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribIuiv)(unsigned index, unsigned pname, PGLuint params);
...
extern DELPHI_PACKAGE void __stdcall (*glUniform1uiv)(int location, int count, PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glUniform2uiv)(int location, int count, PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glUniform3uiv)(int location, int count, PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glUniform4uiv)(int location, int count, PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glGetUniformuiv)(unsigned _program, int location, PGLuint params);
extern DELPHI_PACKAGE void __stdcall (*glBindFragDataLocation)(unsigned _program, unsigned colorNumber, char * name);
extern DELPHI_PACKAGE int __stdcall (*glGetFragDataLocation)(unsigned _program, char * name);
...
extern DELPHI_PACKAGE void __stdcall (*glClearBufferiv)(unsigned buffer, int drawbuffer, PGLint value);
extern DELPHI_PACKAGE void __stdcall (*glClearBufferuiv)(unsigned buffer, int drawbuffer, PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glClearBufferfv)(unsigned buffer, int drawbuffer, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glClearBufferfi)(unsigned buffer, int drawbuffer, float depth, int stencil);
extern DELPHI_PACKAGE char * __stdcall (*glGetStringi)(unsigned name, unsigned index);
extern DELPHI_PACKAGE void __stdcall (*glDrawArraysInstanced)(unsigned mode, int first, int count, int primcount);
extern DELPHI_PACKAGE void __stdcall (*glDrawElementsInstanced)(unsigned mode, int count, unsigned _type, void * indices, int primcount);
...
extern DELPHI_PACKAGE void __stdcall (*glProgramParameteri)(unsigned _program, unsigned pname, int value);
...
extern DELPHI_PACKAGE System::LongBool __stdcall (*wglGetPixelFormatAttribfvARB)(HDC DC, int iPixelFormat, int iLayerPlane, unsigned nAttributes, const PGLint piAttributes, System::PSingle piValues);
extern DELPHI_PACKAGE System::LongBool __stdcall (*wglChoosePixelFormatARB)(HDC DC, const PGLint piAttribIList, const System::PSingle pfAttribFList, unsigned nMaxFormats, PGLint piFormats, PGLenum nNumFormats);
...
extern DELPHI_PACKAGE HDC __stdcall (*wglGetPbufferDCARB)(int hPbuffer);
extern DELPHI_PACKAGE int __stdcall (*wglReleasePbufferDCARB)(int hPbuffer, HDC DC);
extern DELPHI_PACKAGE System::LongBool __stdcall (*wglDestroyPbufferARB)(int hPbuffer);
extern DELPHI_PACKAGE System::LongBool __stdcall (*wglQueryPbufferARB)(int hPbuffer, int iAttribute, PGLint piValue);
extern DELPHI_PACKAGE System::LongBool __stdcall (*wglBindTexImageARB)(int hPbuffer, int iBuffer);
extern DELPHI_PACKAGE System::LongBool __stdcall (*wglReleaseTexImageARB)(int hpBuffer, int iBuffer);
extern DELPHI_PACKAGE System::LongBool __stdcall (*wglSetPbufferAttribARB)(int hpBuffer, const PGLint piAttribList);
extern DELPHI_PACKAGE HGLRC __stdcall (*wglCreateContextAttribsARB)(HDC DC, HGLRC hShareContext, PGLint attribList);
extern DELPHI_PACKAGE bool __fastcall (*wglEnumGpusNV)(unsigned iGpuIndex, NativeUInt &hGpu);
extern DELPHI_PACKAGE bool __fastcall (*wglEnumGpuDevicesNV)(NativeUInt hGpu, unsigned iDeviceIndex, PGPUDEVICE lpGpuDevice);
extern DELPHI_PACKAGE HDC __fastcall (*wglCreateAffinityDCNV)(PHGPUNV hGpuList);
extern DELPHI_PACKAGE bool __fastcall (*wglEnumGpusFromAffinityDCNV)(HDC hAffinityDC, unsigned iGpuIndex, NativeUInt &hGpu);
...
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord1dVARB)(unsigned target, System::PDouble v);
...
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord2dvARB)(unsigned target, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord2fARB)(unsigned target, float s, float t);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord2fvARB)(unsigned target, System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord3dvARB)(unsigned target, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord3fARB)(unsigned target, float s, float t, float r);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord3fvARB)(unsigned target, System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord4dvARB)(unsigned target, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord4fARB)(unsigned target, float s, float t, float r, float q);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoord4fvARB)(unsigned target, System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glLoadTransposeMatrixfARB)(System::PSingle m);
extern DELPHI_PACKAGE void __stdcall (*glLoadTransposeMatrixdARB)(System::PDouble m);
extern DELPHI_PACKAGE void __stdcall (*glMultTransposeMatrixfARB)(System::PSingle m);
extern DELPHI_PACKAGE void __stdcall (*glMultTransposeMatrixdARB)(System::PDouble m);
extern DELPHI_PACKAGE void __stdcall (*glSampleCoverageARB)(float Value, System::ByteBool invert);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexImage3DARB)(unsigned target, int level, unsigned internalformat, int Width, int Height, int depth, int border, int imageSize, void * data);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexImage2DARB)(unsigned target, int level, unsigned internalformat, int Width, int Height, int border, int imageSize, void * data);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexImage1DARB)(unsigned target, int level, unsigned internalformat, int Width, int border, int imageSize, void * data);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexSubImage3DARB)(unsigned target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, unsigned Format, int imageSize, void * data);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexSubImage2DARB)(unsigned target, int level, int xoffset, int yoffset, int width, int height, unsigned Format, int imageSize, void * data);
extern DELPHI_PACKAGE void __stdcall (*glCompressedTexSubImage1DARB)(unsigned target, int level, int xoffset, int width, unsigned Format, int imageSize, void * data);
...
extern DELPHI_PACKAGE void __stdcall (*glPointParameterfvARB)(unsigned pname, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glWeightbvARB)(int size, PGLbyte weights);
extern DELPHI_PACKAGE void __stdcall (*glWeightsvARB)(int size, PGLshort weights);
extern DELPHI_PACKAGE void __stdcall (*glWeightivARB)(int size, PGLint weights);
extern DELPHI_PACKAGE void __stdcall (*glWeightfvARB)(int size, System::PSingle weights);
extern DELPHI_PACKAGE void __stdcall (*glWeightdvARB)(int size, System::PDouble weights);
extern DELPHI_PACKAGE void __stdcall (*glWeightubvARB)(int size, System::PByte weights);
extern DELPHI_PACKAGE void __stdcall (*glWeightusvARB)(int size, System::PWord weights);
extern DELPHI_PACKAGE void __stdcall (*glWeightuivARB)(int size, PGLuint weights);
extern DELPHI_PACKAGE void __stdcall (*glWeightPointerARB)(int size, unsigned _type, int stride, void * _pointer);
...
extern DELPHI_PACKAGE void __stdcall (*glMatrixIndexubvARB)(int size, System::PByte indices);
extern DELPHI_PACKAGE void __stdcall (*glMatrixIndexusvARB)(int size, System::PWord indices);
extern DELPHI_PACKAGE void __stdcall (*glMatrixIndexuivARB)(int size, PGLuint indices);
extern DELPHI_PACKAGE void __stdcall (*glMatrixIndexPointerARB)(int size, unsigned _type, int stride, void * _pointer);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos2dARB)(double x, double y);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos2dvARB)(System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos2fARB)(float x, float y);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos2fvARB)(System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glWindowPos3dvARB)(System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos3fARB)(float x, float y, float z);
extern DELPHI_PACKAGE void __stdcall (*glWindowPos3fvARB)(System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1dvARB)(unsigned index, const System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1fARB)(unsigned index, float x);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1fvARB)(unsigned index, const System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2dvARB)(unsigned index, const System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2fARB)(unsigned index, float x, float y);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2fvARB)(unsigned index, const System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3dvARB)(unsigned index, const System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3fARB)(unsigned index, float x, float y, float z);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3fvARB)(unsigned index, const System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4NubvARB)(unsigned index, const System::PByte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4NuivARB)(unsigned index, const PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4NusvARB)(unsigned index, const System::PWord v);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4dvARB)(unsigned index, const System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4fARB)(unsigned index, float x, float y, float z, float w);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4fvARB)(unsigned index, const System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4ubvARB)(unsigned index, const System::PByte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4uivARB)(unsigned index, const PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4usvARB)(unsigned index, const System::PWord v);
...
extern DELPHI_PACKAGE void __stdcall (*glProgramEnvParameter4dvARB)(unsigned target, unsigned index, const System::PDouble params);
...
extern DELPHI_PACKAGE void __stdcall (*glProgramEnvParameter4fvARB)(unsigned target, unsigned index, const System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glProgramLocalParameter4dvARB)(unsigned target, unsigned index, const System::PDouble params);
...
extern DELPHI_PACKAGE void __stdcall (*glProgramLocalParameter4fvARB)(unsigned target, unsigned index, const System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramEnvParameterdvARB)(unsigned target, unsigned index, System::PDouble params);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramEnvParameterfvARB)(unsigned target, unsigned index, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramLocalParameterdvARB)(unsigned target, unsigned index, System::PDouble params);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramLocalParameterfvARB)(unsigned target, unsigned index, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribdvARB)(unsigned index, unsigned pname, System::PDouble params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribfvARB)(unsigned index, unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glGenQueriesARB)(int n, PGLuint ids);
extern DELPHI_PACKAGE void __stdcall (*glDeleteQueriesARB)(int n, const PGLuint ids);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsQueryARB)(unsigned id);
...
extern DELPHI_PACKAGE void __stdcall (*glGetQueryObjectivARB)(unsigned id, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetQueryObjectuivARB)(unsigned id, unsigned pname, PGLuint params);
extern DELPHI_PACKAGE void __stdcall (*glDeleteObjectARB)(unsigned obj);
extern DELPHI_PACKAGE unsigned __stdcall (*glGetHandleARB)(unsigned pname);
extern DELPHI_PACKAGE void __stdcall (*glDetachObjectARB)(unsigned containerObj, unsigned attachedObj);
extern DELPHI_PACKAGE unsigned __stdcall (*glCreateShaderObjectARB)(unsigned shaderType);
extern DELPHI_PACKAGE void __stdcall (*glShaderSourceARB)(unsigned shaderObj, int count, const PGLPCharArray _string, const PGLint length);
extern DELPHI_PACKAGE void __stdcall (*glCompileShaderARB)(unsigned shaderObj);
extern DELPHI_PACKAGE unsigned __stdcall (*glCreateProgramObjectARB)(void);
extern DELPHI_PACKAGE void __stdcall (*glAttachObjectARB)(unsigned containerObj, unsigned obj);
extern DELPHI_PACKAGE void __stdcall (*glLinkProgramARB)(unsigned programObj);
extern DELPHI_PACKAGE void __stdcall (*glUseProgramObjectARB)(unsigned programObj);
extern DELPHI_PACKAGE void __stdcall (*glValidateProgramARB)(unsigned programObj);
...
extern DELPHI_PACKAGE void __stdcall (*glUniform1fvARB)(int location, int count, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniform2fvARB)(int location, int count, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniform3fvARB)(int location, int count, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniform4fvARB)(int location, int count, System::PSingle value);
...
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix2fvARB)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix3fvARB)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix4fvARB)(int location, int count, System::ByteBool transpose, System::PSingle value);
extern DELPHI_PACKAGE void __stdcall (*glGetObjectParameterfvARB)(unsigned obj, unsigned pname, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetObjectParameterivARB)(unsigned obj, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetInfoLogARB)(unsigned obj, int maxLength, PGLsizei length, char * infoLog);
extern DELPHI_PACKAGE void __stdcall (*glGetAttachedObjectsARB)(unsigned containerObj, int maxCount, PGLsizei count, PGLhandleARB obj);
extern DELPHI_PACKAGE int __stdcall (*glGetUniformLocationARB)(unsigned programObj, const char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveUniformARB)(unsigned programObj, unsigned index, int maxLength, PGLsizei length, PGLint size, PGLenum _type, char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetUniformfvARB)(unsigned programObj, int location, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetUniformivARB)(unsigned programObj, int location, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetShaderSourceARB)(unsigned obj, int maxLength, PGLsizei length, char * source);
extern DELPHI_PACKAGE void __stdcall (*glBindAttribLocationARB)(unsigned programObj, unsigned index, const char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveAttribARB)(unsigned programObj, unsigned index, int maxLength, PGLsizei length, PGLint size, PGLenum _type, char * name);
extern DELPHI_PACKAGE int __stdcall (*glGetAttribLocationARB)(unsigned programObj, const char * name);
...
extern DELPHI_PACKAGE void __stdcall (*glDrawElementsInstancedARB)(unsigned mode, int count, unsigned _type, void * indices, int primcount);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsRenderbuffer)(unsigned renderbuffer);
extern DELPHI_PACKAGE void __stdcall (*glBindRenderbuffer)(unsigned target, unsigned renderbuffer);
extern DELPHI_PACKAGE void __stdcall (*glDeleteRenderbuffers)(int n, PGLuint renderbuffers);
extern DELPHI_PACKAGE void __stdcall (*glGenRenderbuffers)(int n, PGLuint renderbuffers);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsFramebuffer)(unsigned framebuffer);
extern DELPHI_PACKAGE void __stdcall (*glBindFramebuffer)(unsigned target, unsigned framebuffer);
extern DELPHI_PACKAGE void __stdcall (*glDeleteFramebuffers)(int n, PGLuint framebuffers);
extern DELPHI_PACKAGE void __stdcall (*glGenFramebuffers)(int n, PGLuint framebuffers);
...
extern DELPHI_PACKAGE void __stdcall (*glFramebufferTexture3D)(unsigned target, unsigned attachment, unsigned textarget, unsigned texture, int level, int layer);
...
extern DELPHI_PACKAGE void __stdcall (*glProgramParameteriARB)(unsigned _program, unsigned pname, int value);
...
extern DELPHI_PACKAGE void * __stdcall (*glMapBufferRange)(unsigned target, int offset, int length, unsigned access);
extern DELPHI_PACKAGE void __stdcall (*glFlushMappedBufferRange)(unsigned target, int offset, int length);
extern DELPHI_PACKAGE void __stdcall (*glTexBufferARB)(unsigned target, unsigned internalformat, unsigned buffer);
extern DELPHI_PACKAGE void __stdcall (*glBindVertexArray)(unsigned _array);
extern DELPHI_PACKAGE void __stdcall (*glDeleteVertexArrays)(int n, PGLuint arrays);
extern DELPHI_PACKAGE void __stdcall (*glGenVertexArrays)(int n, PGLuint arrays);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsVertexArray)(unsigned _array);
extern DELPHI_PACKAGE void __stdcall (*glGetUniformIndices)(unsigned _program, int uniformCount, PGLPCharArray uniformNames, PGLuint uniformIndices);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveUniformsiv)(unsigned _program, int uniformCount, PGLuint uniformIndices, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveUniformName)(unsigned _program, unsigned uniformIndex, int bufSize, PGLsizei length, char * uniformName);
extern DELPHI_PACKAGE unsigned __stdcall (*glGetUniformBlockIndex)(unsigned _program, char * uniformBlockName);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveUniformBlockiv)(unsigned _program, unsigned uniformBlockIndex, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveUniformBlockName)(unsigned _program, unsigned uniformBlockIndex, int bufSize, PGLsizei length, char * uniformBlockName);
extern DELPHI_PACKAGE void __stdcall (*glUniformBlockBinding)(unsigned _program, unsigned uniformBlockIndex, unsigned uniformBlockBinding);
...
extern DELPHI_PACKAGE void __stdcall (*glDrawElementsBaseVertex)(unsigned mode, int count, unsigned _type, void * indices, int basevertex);
extern DELPHI_PACKAGE void __stdcall (*glDrawRangeElementsBaseVertex)(unsigned mode, unsigned start, unsigned _end, int count, unsigned _type, void * indices, int basevertex);
extern DELPHI_PACKAGE void __stdcall (*glDrawElementsInstancedBaseVertex)(unsigned mode, int count, unsigned _type, void * indices, int primcount, int basevertex);
extern DELPHI_PACKAGE void __stdcall (*glMultiDrawElementsBaseVertex)(unsigned mode, PGLsizei count, unsigned _type, void *indices, int primcount, PGLint basevertex);
extern DELPHI_PACKAGE void __stdcall (*glProvokingVertex)(unsigned mode);
extern DELPHI_PACKAGE NativeInt __stdcall (*glFenceSync)(unsigned condition, unsigned flags);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsSync)(NativeInt sync);
extern DELPHI_PACKAGE void __stdcall (*glDeleteSync)(NativeInt sync);
extern DELPHI_PACKAGE unsigned __stdcall (*glClientWaitSync)(NativeInt sync, unsigned flags, unsigned __int64 timeout);
extern DELPHI_PACKAGE void __stdcall (*glWaitSync)(NativeInt sync, unsigned flags, unsigned __int64 timeout);
extern DELPHI_PACKAGE void __stdcall (*glGetInteger64v)(unsigned pname, PGLint64 params);
extern DELPHI_PACKAGE void __stdcall (*glGetSynciv)(NativeInt sync, unsigned pname, int bufSize, PGLsizei length, PGLint values);
extern DELPHI_PACKAGE void __stdcall (*glTexImage2DMultisample)(unsigned target, int samples, int internalformat, int width, int height, System::ByteBool fixedsamplelocations);
extern DELPHI_PACKAGE void __stdcall (*glTexImage3DMultisample)(unsigned target, int samples, int internalformat, int width, int height, int depth, System::ByteBool fixedsamplelocations);
extern DELPHI_PACKAGE void __stdcall (*glGetMultisamplefv)(unsigned pname, unsigned index, System::PSingle val);
...
extern DELPHI_PACKAGE void __stdcall (*glBindFragDataLocationIndexed)(unsigned _program, unsigned colorNumber, unsigned index, const char * name);
extern DELPHI_PACKAGE int __stdcall (*glGetFragDataIndex)(unsigned _program, const char * name);
extern DELPHI_PACKAGE void __stdcall (*glGenSamplers)(int count, PGLuint samplers);
extern DELPHI_PACKAGE void __stdcall (*glDeleteSamplers)(int count, const PGLuint samplers);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsSampler)(unsigned sampler);
extern DELPHI_PACKAGE void __stdcall (*glBindSampler)(unsigned _unit, unsigned sampler);
extern DELPHI_PACKAGE void __stdcall (*glSamplerParameteri)(unsigned sampler, unsigned pname, int param);
extern DELPHI_PACKAGE void __stdcall (*glSamplerParameteriv)(unsigned sampler, unsigned pname, const PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glSamplerParameterf)(unsigned sampler, unsigned pname, float param);
extern DELPHI_PACKAGE void __stdcall (*glSamplerParameterfv)(unsigned sampler, unsigned pname, const System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glSamplerParameterIiv)(unsigned sampler, unsigned pname, const PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glSamplerParameterIuiv)(unsigned sampler, unsigned pname, const PGLuint params);
extern DELPHI_PACKAGE void __stdcall (*glGetSamplerParameteriv)(unsigned sampler, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetSamplerParameterIiv)(unsigned sampler, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetSamplerParameterfv)(unsigned sampler, unsigned pname, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetSamplerParameterIfv)(unsigned sampler, unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexP2ui)(unsigned _type, unsigned value);
extern DELPHI_PACKAGE void __stdcall (*glVertexP2uiv)(unsigned _type, const PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glVertexP3ui)(unsigned _type, unsigned value);
extern DELPHI_PACKAGE void __stdcall (*glVertexP3uiv)(unsigned _type, const PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glVertexP4ui)(unsigned _type, unsigned value);
extern DELPHI_PACKAGE void __stdcall (*glVertexP4uiv)(unsigned _type, const PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glTexCoordP1ui)(unsigned _type, unsigned coords);
extern DELPHI_PACKAGE void __stdcall (*glTexCoordP1uiv)(unsigned _type, const PGLuint coords);
extern DELPHI_PACKAGE void __stdcall (*glTexCoordP2ui)(unsigned _type, unsigned coords);
extern DELPHI_PACKAGE void __stdcall (*glTexCoordP2uiv)(unsigned _type, const PGLuint coords);
extern DELPHI_PACKAGE void __stdcall (*glTexCoordP3ui)(unsigned _type, unsigned coords);
extern DELPHI_PACKAGE void __stdcall (*glTexCoordP3uiv)(unsigned _type, const PGLuint coords);
extern DELPHI_PACKAGE void __stdcall (*glTexCoordP4ui)(unsigned _type, unsigned coords);
extern DELPHI_PACKAGE void __stdcall (*glTexCoordP4uiv)(unsigned _type, const PGLuint coords);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoordP1ui)(unsigned texture, unsigned _type, unsigned coords);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoordP1uiv)(unsigned texture, unsigned _type, const PGLuint coords);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoordP2ui)(unsigned texture, unsigned _type, unsigned coords);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoordP2uiv)(unsigned texture, unsigned _type, const PGLuint coords);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoordP3ui)(unsigned texture, unsigned _type, unsigned coords);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoordP3uiv)(unsigned texture, unsigned _type, const PGLuint coords);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoordP4ui)(unsigned texture, unsigned _type, unsigned coords);
extern DELPHI_PACKAGE void __stdcall (*glMultiTexCoordP4uiv)(unsigned texture, unsigned _type, const PGLuint coords);
extern DELPHI_PACKAGE void __stdcall (*glNormalP3ui)(unsigned _type, unsigned coords);
extern DELPHI_PACKAGE void __stdcall (*glNormalP3uiv)(unsigned _type, const PGLuint coords);
extern DELPHI_PACKAGE void __stdcall (*glColorP3ui)(unsigned _type, unsigned color);
extern DELPHI_PACKAGE void __stdcall (*glColorP3uiv)(unsigned _type, const PGLuint color);
extern DELPHI_PACKAGE void __stdcall (*glColorP4ui)(unsigned _type, unsigned color);
extern DELPHI_PACKAGE void __stdcall (*glColorP4uiv)(unsigned _type, const PGLuint color);
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColorP3ui)(unsigned _type, unsigned color);
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColorP3uiv)(unsigned _type, const PGLuint color);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribP1ui)(unsigned index, unsigned _type, System::ByteBool normalized, unsigned value);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribP1uiv)(unsigned index, unsigned _type, System::ByteBool normalized, const PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribP2ui)(unsigned index, unsigned _type, System::ByteBool normalized, unsigned value);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribP2uiv)(unsigned index, unsigned _type, System::ByteBool normalized, const PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribP3ui)(unsigned index, unsigned _type, System::ByteBool normalized, unsigned value);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribP3uiv)(unsigned index, unsigned _type, System::ByteBool normalized, const PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribP4ui)(unsigned index, unsigned _type, System::ByteBool normalized, unsigned value);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribP4uiv)(unsigned index, unsigned _type, System::ByteBool normalized, const PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glDrawArraysIndirect)(unsigned mode, const void * indirect);
extern DELPHI_PACKAGE void __stdcall (*glDrawElementsIndirect)(unsigned mode, unsigned _type, const void * indirect);
...
extern DELPHI_PACKAGE void __stdcall (*glUniform1dv)(int location, int count, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniform2dv)(int location, int count, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniform3dv)(int location, int count, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniform4dv)(int location, int count, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix2dv)(int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix3dv)(int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix4dv)(int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix2x3dv)(int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix2x4dv)(int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix3x2dv)(int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix3x4dv)(int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix4x2dv)(int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glUniformMatrix4x3dv)(int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glGetUniformdv)(unsigned _program, int location, System::PDouble params);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniform1dEXT)(unsigned _program, int location, double x);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniform2dEXT)(unsigned _program, int location, double x, double y);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniform3dEXT)(unsigned _program, int location, double x, double y, double z);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniform4dEXT)(unsigned _program, int location, double x, double y, double z, double w);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniform1dvEXT)(unsigned _program, int location, int count, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniform2dvEXT)(unsigned _program, int location, int count, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniform3dvEXT)(unsigned _program, int location, int count, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniform4dvEXT)(unsigned _program, int location, int count, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformMatrix2dvEXT)(unsigned _program, int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformMatrix3dvEXT)(unsigned _program, int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformMatrix4dvEXT)(unsigned _program, int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformMatrix2x3dvEXT)(unsigned _program, int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformMatrix2x4dvEXT)(unsigned _program, int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformMatrix3x2dvEXT)(unsigned _program, int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformMatrix3x4dvEXT)(unsigned _program, int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformMatrix4x2dvEXT)(unsigned _program, int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformMatrix4x3dvEXT)(unsigned _program, int location, int count, System::ByteBool transpose, const System::PDouble value);
extern DELPHI_PACKAGE int __stdcall (*glGetSubroutineUniformLocation)(unsigned _program, unsigned shadertype, const char * name);
extern DELPHI_PACKAGE unsigned __stdcall (*glGetSubroutineIndex)(unsigned _program, unsigned shadertype, const char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveSubroutineUniformiv)(unsigned _program, unsigned shadertype, unsigned index, unsigned pname, PGLint values);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveSubroutineUniformName)(unsigned _program, unsigned shadertype, unsigned index, int bufsize, PGLsizei length, char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveSubroutineName)(unsigned _program, unsigned shadertype, unsigned index, int bufsize, PGLsizei length, char * name);
extern DELPHI_PACKAGE void __stdcall (*glUniformSubroutinesuiv)(unsigned shadertype, int count, const PGLuint indices);
extern DELPHI_PACKAGE void __stdcall (*glGetUniformSubroutineuiv)(unsigned shadertype, int location, PGLuint params);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramStageiv)(unsigned _program, unsigned shadertype, unsigned pname, PGLint values);
extern DELPHI_PACKAGE void __stdcall (*glPatchParameteri)(unsigned pname, int value);
extern DELPHI_PACKAGE void __stdcall (*glPatchParameterfv)(unsigned pname, const System::PSingle values);
extern DELPHI_PACKAGE void __stdcall (*glBindTransformFeedback)(unsigned target, unsigned id);
extern DELPHI_PACKAGE void __stdcall (*glDeleteTransformFeedbacks)(int n, const PGLuint ids);
extern DELPHI_PACKAGE void __stdcall (*glGenTransformFeedbacks)(int n, PGLuint ids);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsTransformFeedback)(unsigned id);
...
extern DELPHI_PACKAGE void __stdcall (*glGetQueryIndexediv)(unsigned target, unsigned index, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glArrayElementArrayEXT)(unsigned mode, int count, void * pi);
extern DELPHI_PACKAGE void __stdcall (*glAddSwapHintRectWIN)(int x, int y, int width, int height);
...
extern DELPHI_PACKAGE void __stdcall (*glTexImage3DEXT)(unsigned target, int level, unsigned internalformat, int width, int height, int depth, int border, unsigned Format, unsigned AType, void * pixels);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glAreTexturesResidentEXT)(int n, PGLuint textures, PGLboolean residences);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsTextureEXT)(unsigned texture);
extern DELPHI_PACKAGE void __stdcall (*glSampleMaskSGIS)(float Value, System::ByteBool invert);
...
extern DELPHI_PACKAGE void __stdcall (*glGetColorTableParameterfvEXT)(unsigned target, unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glDrawRangeElementsEXT)(unsigned mode, unsigned start, unsigned Aend, int Count, unsigned Atype, void * indices);
...
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColor3dvEXT)(System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColor3fEXT)(float red, float green, float blue);
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColor3fvEXT)(System::PSingle v);
...
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColor3ubvEXT)(System::PByte v);
...
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColor3usvEXT)(System::PWord v);
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColorPointerEXT)(int Size, unsigned Atype, int stride, void * p);
extern DELPHI_PACKAGE void __stdcall (*glMultiDrawArraysEXT)(unsigned mode, PGLint First, PGLsizei Count, int primcount);
extern DELPHI_PACKAGE void __stdcall (*glMultiDrawElementsEXT)(unsigned mode, PGLsizei Count, unsigned AType, void *indices, int primcount);
extern DELPHI_PACKAGE void __stdcall (*glFogCoordfEXT)(float coord);
extern DELPHI_PACKAGE void __stdcall (*glFogCoordfvEXT)(System::PSingle coord);
extern DELPHI_PACKAGE void __stdcall (*glFogCoorddEXT)(double coord);
extern DELPHI_PACKAGE void __stdcall (*glFogCoorddvEXT)(System::PDouble coord);
extern DELPHI_PACKAGE void __stdcall (*glFogCoordPointerEXT)(unsigned AType, int stride, void * p);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexArrayRangeNV)(int Size, void * p);
extern DELPHI_PACKAGE void * __stdcall (*wglAllocateMemoryNV)(int size, float readFrequency, float writeFrequency, float priority);
extern DELPHI_PACKAGE void __stdcall (*wglFreeMemoryNV)(void * ptr);
extern DELPHI_PACKAGE void __stdcall (*glCombinerParameterfvNV)(unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glCombinerOutputNV)(unsigned stage, unsigned portion, unsigned abOutput, unsigned cdOutput, unsigned sumOutput, unsigned scale, unsigned bias, System::ByteBool abDotProduct, System::ByteBool cdDotProduct, System::ByteBool muxSum);
...
extern DELPHI_PACKAGE void __stdcall (*glGetCombinerInputParameterfvNV)(unsigned stage, unsigned portion, unsigned variable, unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glGetCombinerOutputParameterfvNV)(unsigned stage, unsigned portion, unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glGetFinalCombinerInputParameterfvNV)(unsigned variable, unsigned pname, System::PSingle params);
...
extern DELPHI_PACKAGE void __stdcall (*glSampleMaskEXT)(float Value, System::ByteBool invert);
extern DELPHI_PACKAGE void __stdcall (*glSamplePatternEXT)(unsigned pattern);
extern DELPHI_PACKAGE void __stdcall (*glTextureColorMaskSGIS)(System::ByteBool red, System::ByteBool green, System::ByteBool blue, System::ByteBool alpha);
extern DELPHI_PACKAGE void __stdcall (*glGenFencesNV)(int n, PGLuint fences);
extern DELPHI_PACKAGE void __stdcall (*glDeleteFencesNV)(int n, PGLuint fences);
extern DELPHI_PACKAGE void __stdcall (*glSetFenceNV)(unsigned fence, unsigned condition);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glTestFenceNV)(unsigned fence);
extern DELPHI_PACKAGE void __stdcall (*glFinishFenceNV)(unsigned fence);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsFenceNV)(unsigned fence);
extern DELPHI_PACKAGE void __stdcall (*glGetFenceivNV)(unsigned fence, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glAreProgramsResidentNV)(int n, PGLuint programs, PGLboolean residences);
extern DELPHI_PACKAGE void __stdcall (*glBindProgramNV)(unsigned target, unsigned id);
extern DELPHI_PACKAGE void __stdcall (*glDeleteProgramsNV)(int n, PGLuint programs);
extern DELPHI_PACKAGE void __stdcall (*glExecuteProgramNV)(unsigned target, unsigned id, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGenProgramsNV)(int n, PGLuint programs);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramParameterdvNV)(unsigned target, unsigned index, unsigned pname, System::PDouble params);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramParameterfvNV)(unsigned target, unsigned index, unsigned pname, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramivNV)(unsigned id, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetProgramStringNV)(unsigned id, unsigned pname, System::PByte programIdx);
extern DELPHI_PACKAGE void __stdcall (*glGetTrackMatrixivNV)(unsigned target, unsigned address, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribdvNV)(unsigned index, unsigned pname, System::PDouble params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribfvNV)(unsigned index, unsigned pname, System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribivNV)(unsigned index, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribPointervNV)(unsigned index, unsigned pname, PGLPointer pointer);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsProgramNV)(unsigned id);
extern DELPHI_PACKAGE void __stdcall (*glLoadProgramNV)(unsigned target, unsigned id, int len, System::PByte programIdx);
...
extern DELPHI_PACKAGE void __stdcall (*glProgramParameter4dvNV)(unsigned target, unsigned index, System::PDouble v);
...
extern DELPHI_PACKAGE void __stdcall (*glProgramParameter4fvNV)(unsigned target, unsigned index, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glProgramParameters4dvNV)(unsigned target, unsigned index, int count, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glProgramParameters4fvNV)(unsigned target, unsigned index, int count, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glRequestResidentProgramsNV)(int n, PGLuint programs);
extern DELPHI_PACKAGE void __stdcall (*glTrackMatrixNV)(unsigned target, unsigned address, unsigned matrix, unsigned transform);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribPointerNV)(unsigned index, int fsize, unsigned vertextype, int stride, void * pointer);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1dNV)(unsigned index, double x);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1dvNV)(unsigned index, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1fNV)(unsigned index, float x);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1fvNV)(unsigned index, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1sNV)(unsigned index, short x);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib1svNV)(unsigned index, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2dNV)(unsigned index, double x, double y);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2dvNV)(unsigned index, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2fNV)(unsigned index, float x, float y);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2fvNV)(unsigned index, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2sNV)(unsigned index, short x, short y);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib2svNV)(unsigned index, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3dNV)(unsigned index, double x, double y, double z);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3dvNV)(unsigned index, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3fNV)(unsigned index, float x, float y, float z);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3fvNV)(unsigned index, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3sNV)(unsigned index, short x, short y, short z);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib3svNV)(unsigned index, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4dNV)(unsigned index, double x, double y, double z, double w);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4dvNV)(unsigned index, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4fNV)(unsigned index, float x, float y, float z, float w);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4fvNV)(unsigned index, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4sNV)(unsigned index, short x, short y, double z, short w);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4svNV)(unsigned index, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttrib4ubvNV)(unsigned index, System::PByte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs1dvNV)(unsigned index, int count, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs1fvNV)(unsigned index, int count, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs1svNV)(unsigned index, int count, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs2dvNV)(unsigned index, int count, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs2fvNV)(unsigned index, int count, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs2svNV)(unsigned index, int count, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs3dvNV)(unsigned index, int count, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs3fvNV)(unsigned index, int count, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs3svNV)(unsigned index, int count, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs4dvNV)(unsigned index, int count, System::PDouble v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs4fvNV)(unsigned index, int count, System::PSingle v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs4svNV)(unsigned index, int count, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribs4ubvNV)(unsigned index, int count, System::PByte v);
extern DELPHI_PACKAGE void __stdcall (*glGenOcclusionQueriesNV)(int n, PGLuint ids);
extern DELPHI_PACKAGE void __stdcall (*glDeleteOcclusionQueriesNV)(int n, const PGLuint ids);
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsOcclusionQueryNV)(unsigned id);
...
extern DELPHI_PACKAGE void __stdcall (*glGetOcclusionQueryivNV)(unsigned id, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetOcclusionQueryuivNV)(unsigned id, unsigned pname, PGLuint params);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsRenderbufferEXT)(unsigned renderbuffer);
extern DELPHI_PACKAGE void __stdcall (*glBindRenderbufferEXT)(unsigned target, unsigned renderbuffer);
extern DELPHI_PACKAGE void __stdcall (*glDeleteRenderbuffersEXT)(int n, PGLuint renderbuffers);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsFramebufferEXT)(unsigned framebuffer);
extern DELPHI_PACKAGE void __stdcall (*glBindFramebufferEXT)(unsigned target, unsigned framebuffer);
extern DELPHI_PACKAGE void __stdcall (*glDeleteFramebuffersEXT)(int n, PGLuint framebuffers);
...
extern DELPHI_PACKAGE void __stdcall (*glGetQueryObjecti64vEXT)(unsigned id, unsigned pname, PGLint64EXT params);
extern DELPHI_PACKAGE void __stdcall (*glGetQueryObjectui64vEXT)(unsigned id, unsigned pname, PGLuint64EXT params);
extern DELPHI_PACKAGE void __stdcall (*glProgramEnvParameters4fvEXT)(unsigned target, unsigned index, int count, const System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glProgramLocalParameters4fvEXT)(unsigned target, unsigned index, int count, const System::PSingle params);
extern DELPHI_PACKAGE void __stdcall (*glProgramVertexLimitNV)(unsigned target, int limit);
extern DELPHI_PACKAGE void __stdcall (*glProgramParameteriEXT)(unsigned _program, unsigned pname, int value);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI1ivEXT)(unsigned index, PGLint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI2ivEXT)(unsigned index, PGLint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI3ivEXT)(unsigned index, PGLint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4ivEXT)(unsigned index, PGLint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI1uivEXT)(unsigned index, PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI2uivEXT)(unsigned index, PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI3uivEXT)(unsigned index, PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4uivEXT)(unsigned index, PGLuint v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4bvEXT)(unsigned index, PGLbyte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4svEXT)(unsigned index, PGLshort v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4ubvEXT)(unsigned index, System::PByte v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribI4usvEXT)(unsigned index, System::PWord v);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribIPointerEXT)(unsigned index, int size, unsigned _type, int stride, void * _pointer);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribIivEXT)(unsigned index, unsigned pname, PGLint params);
extern DELPHI_PACKAGE void __stdcall (*glGetVertexAttribIuivEXT)(unsigned index, unsigned pname, PGLuint params);
...
extern DELPHI_PACKAGE void __stdcall (*glUniform1uivEXT)(int location, int count, PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glUniform2uivEXT)(int location, int count, PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glUniform3uivEXT)(int location, int count, PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glUniform4uivEXT)(int location, int count, PGLuint value);
extern DELPHI_PACKAGE void __stdcall (*glGetUniformuivEXT)(unsigned _program, int location, PGLuint params);
extern DELPHI_PACKAGE void __stdcall (*glBindFragDataLocationEXT)(unsigned _program, unsigned colorNumber, char * name);
extern DELPHI_PACKAGE int __stdcall (*glGetFragDataLocationEXT)(unsigned _program, char * name);
extern DELPHI_PACKAGE void __stdcall (*glDrawArraysInstancedEXT)(unsigned mode, int first, int count, int primcount);
extern DELPHI_PACKAGE void __stdcall (*glDrawElementsInstancedEXT)(unsigned mode, int count, unsigned _type, void * indices, int primcount);
extern DELPHI_PACKAGE void __stdcall (*glTexBufferEXT)(unsigned target, unsigned internalformat, unsigned buffer);
extern DELPHI_PACKAGE void __stdcall (*glColorMaskIndexedEXT)(unsigned buf, System::ByteBool r, System::ByteBool g, System::ByteBool b, System::ByteBool a);
extern DELPHI_PACKAGE void __stdcall (*glGetBooleanIndexedvEXT)(unsigned value, unsigned index, PGLboolean data);
extern DELPHI_PACKAGE void __stdcall (*glGetIntegerIndexedvEXT)(unsigned value, unsigned index, PGLint data);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsEnabledIndexedEXT)(unsigned target, unsigned index);
...
extern DELPHI_PACKAGE void __stdcall (*glTransformFeedbackAttribsNV)(int count, PGLint attribs, unsigned bufferMode);
extern DELPHI_PACKAGE void __stdcall (*glTransformFeedbackVaryingsNV)(unsigned _program, int count, PGLint locations, unsigned bufferMode);
...
extern DELPHI_PACKAGE int __stdcall (*glGetVaryingLocationNV)(unsigned _program, char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetActiveVaryingNV)(unsigned _program, unsigned index, int bufSize, PGLsizei length, PGLsizei size, unsigned _type, char * name);
extern DELPHI_PACKAGE void __stdcall (*glActiveVaryingNV)(unsigned _program, char * name);
extern DELPHI_PACKAGE void __stdcall (*glGetTransformFeedbackVaryingNV)(unsigned _program, unsigned index, PGLint location);
extern DELPHI_PACKAGE void __stdcall (*glUniformBufferEXT)(unsigned _program, int location, unsigned buffer);
extern DELPHI_PACKAGE int __stdcall (*glGetUniformBufferSizeEXT)(unsigned _program, int location);
extern DELPHI_PACKAGE PGLint __stdcall (*glGetUniformOffsetEXT)(unsigned _program, int location);
extern DELPHI_PACKAGE void __stdcall (*glClearColorIiEXT)(int r, int g, int b, int a);
extern DELPHI_PACKAGE void __stdcall (*glClearColorIuiEXT)(unsigned r, unsigned g, unsigned b, unsigned a);
...
extern DELPHI_PACKAGE void __stdcall (*glTransformFeedbackVaryingsEXT)(unsigned _program, int count, const PGLPCharArray varyings, unsigned bufferMode);
extern DELPHI_PACKAGE void __stdcall (*glGetTransformFeedbackVaryingEXT)(unsigned _program, unsigned index, int bufSize, PGLsizei length, PGLsizei size, PGLenum _type, char * name);
...
extern DELPHI_PACKAGE System::ByteBool __stdcall (*glIsNamedBufferResidentNV)(unsigned buffer);
...
extern DELPHI_PACKAGE void __stdcall (*glGetUniformui64vNV)(unsigned _program, int location, PGLuint64EXT params);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformui64NV)(unsigned _program, int location, unsigned __int64 value);
extern DELPHI_PACKAGE void __stdcall (*glProgramUniformui64vNV)(unsigned _program, int location, int count, const PGLuint64EXT value);
...
extern DELPHI_PACKAGE void __stdcall (*glVertexFormatNV)(int size, unsigned _type, int stride);
extern DELPHI_PACKAGE void __stdcall (*glNormalFormatNV)(unsigned _type, int stride);
extern DELPHI_PACKAGE void __stdcall (*glColorFormatNV)(int size, unsigned _type, int stride);
extern DELPHI_PACKAGE void __stdcall (*glIndexFormatNV)(unsigned _type, int stride);
extern DELPHI_PACKAGE void __stdcall (*glTexCoordFormatNV)(int size, unsigned _type, int stride);
extern DELPHI_PACKAGE void __stdcall (*glEdgeFlagFormatNV)(int stride);
extern DELPHI_PACKAGE void __stdcall (*glSecondaryColorFormatNV)(int size, unsigned _type, int stride);
extern DELPHI_PACKAGE void __stdcall (*glFogCoordFormatNV)(unsigned _type, int stride);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribFormatNV)(unsigned index, int size, unsigned _type, System::ByteBool normalized, int stride);
extern DELPHI_PACKAGE void __stdcall (*glVertexAttribIFormatNV)(unsigned index, int size, unsigned _type, int stride);
...
extern DELPHI_PACKAGE void __stdcall (*glStringMarkerGREMEDY)(int len, char * str);
extern DELPHI_PACKAGE bool vIgnoreOpenGLErrors;
extern DELPHI_PACKAGE void * __fastcall GLGetProcAddress(char * ProcName);
