...
begin
  ...
  FNewtonWorld := NewtonCreate();
  FDllVersion := NewtonWorldGetVersion();
...
begin
  ...
  if not(csDesigning in ComponentState) then
///    NewtonMaterialSetDefaultFriction(FNewtonWorld, id0 : Integer; id1 : Integer; staticFriction : dFloat; kineticFriction : dFloat);
...
begin
  ...
  begin
    ...
    NewtonDestroyCollision(FManager.FNewtonWorld, FCollision);
